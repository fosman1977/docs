...
List all barristers with availability data.
...
```json
{
  "data": {
    ...
    "availability": {
      ...
      "utilisation": 45,
      "weeklyBreakdown": [
        { "day": "Monday", "utilisation": 80 },
        { "day": "Tuesday", "utilisation": 40 },
        { "day": "Wednesday", "utilisation": 20 },
        { "day": "Thursday", "utilisation": 60 },
        { "day": "Friday", "utilisation": 25 }
      ]
    },
    "currentLeads": [
      {
    ...
    "suggestions": [
      {
        ...
        "reasons": [
          ...
          "Currently has capacity (45% utilisation)"
        ],
